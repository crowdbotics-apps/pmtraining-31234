"""pmtraining_31234 URL Configuration
...
admin.site.site_header = "PMTraining"
admin.site.site_title = "PMTraining Admin Portal"
admin.site.index_title = "PMTraining Admin"

# swagger
api_info = openapi.Info(
    title="PMTraining API",
    default_version="v1",
    description="API documentation for PMTraining App",
)
